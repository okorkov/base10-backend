...
financial_data4 = FinancialDatum.create(data_period: "quarter", revenue: 4, burn: 2.25, gp_pct: 0.57, gp_amount: 2.28, cash:7.5 , next_fundraise: Date.new(2024,01,01), created_at: Date.new(2022,12,31), company_id: c.id)
